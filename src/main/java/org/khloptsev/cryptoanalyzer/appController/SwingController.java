...
import org.khloptsev.cryptoanalyzer.model.actions.*;
...
public class SwingController {
    ...
    private void initActionButtonsListeners() {
        ...
        for (JButton button : buttons) {
            button.addActionListener((event) -> actionHandler(button));
        }
    }
    ...
    private void initIOButtonsHandlers() {
        ...
        input.addActionListener((event) -> inputButtonHandler());

        output.addActionListener((event) -> outputButtonHandler());
    }

    private void initExecuteButton() {
        JButton executeButton = view.getExecuteButton();
        executeButton.addActionListener((event) -> executeButtonHandler());
    }
